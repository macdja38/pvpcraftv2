...
exports.fetchWithYtdl = fetchWithYtdl;
exports.fetchWithYoutubeDl = fetchWithYoutubeDl;
...
function fetchWithYoutubeDl(link) {
  return new Promise((resolve, reject) => {
...
function getStreamUrl(info) {
  ...
  let opusItems = this.info.formats.filter(f => isEncodedAs(f, "opus"));
  ...
  formats = this.info.formats.sort((a, b) => b.abr - a.abr);
  if (formats.length > 0) {
